<template>
  <div>
    <div class="alert alert-warning alert-dismissible fade show" role="alert" v-if="message" key="message">
      {{ message }}
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert" v-if="getType(error) === 'object'"
         key="error-list">
      <ul>
